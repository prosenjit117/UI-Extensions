import { type Dispatch, type HTMLProps, type MutableRefObject, type ReactNode, type RefObject, type SetStateAction } from 'react';
import { type PaginationProps, type ActionIconProps, type AlertProps, type AutocompleteProps, type BadgeProps, type BoxProps, type CheckboxProps, type HighlightProps, type ModalProps, type MultiSelectProps, type PaperProps, type ProgressProps, type RadioProps, type RangeSliderProps, type SelectProps, type SkeletonProps, type SwitchProps, type TableProps, type TextInputProps, type UnstyledButtonProps, type LoadingOverlayProps } from '@mantine/core';
import { type DateInputProps } from '@mantine/dates';
import { type AccessorFn, type DeepValue, type AggregationFn, type Cell, type Column, type ColumnDef, type ColumnFiltersState, type ColumnOrderState, type ColumnPinningState, type ColumnSizingInfoState, type ColumnSizingState, type DeepKeys, type ExpandedState, type FilterFn, type GroupingState, type Header, type HeaderGroup, type OnChangeFn, type PaginationState, type Row, type RowSelectionState, type SortingFn, type SortingState, type Table, type TableOptions, type TableState, type Updater, type VisibilityState } from '@tanstack/react-table';
...
export type HTMLPropsRef<T extends HTMLElement> = Omit<HTMLProps<T>, 'color' | 'size' | 'type' | 'ref' | 'data' | 'label' | 'style'> & {
...
export type MRT_VirtualizerOptions<TScrollElement extends Element | Window = Element | Window, TItemElement extends Element = Element> = VirtualizerOptions<TScrollElement, TItemElement>;
export type MRT_ColumnVirtualizer<TScrollElement extends Element | Window = HTMLDivElement, TItemElement extends Element = HTMLTableCellElement> = Virtualizer<TScrollElement, TItemElement> & {
    virtualColumns: MRT_VirtualItem[];
    virtualPaddingLeft?: number;
    virtualPaddingRight?: number;
};
export type MRT_RowVirtualizer<TScrollElement extends Element | Window = HTMLDivElement, TItemElement extends Element = HTMLTableRowElement> = Virtualizer<TScrollElement, TItemElement> & {
...
export type MRT_TableState<TData extends MRT_RowData> = Prettify<TableState & {
...
export type MRT_Column<TData extends MRT_RowData, TValue = unknown> = Omit<Column<TData, unknown>, 'header' | 'footer' | 'columns' | 'columnDef' | 'filterFn'> & {
...
export type MRT_Header<TData extends MRT_RowData, TValue = unknown> = Omit<Header<TData, unknown>, 'column'> & {
    column: MRT_Column<TData, TValue>;
};
export type MRT_HeaderGroup<TData extends MRT_RowData> = Omit<HeaderGroup<TData>, 'headers'> & {
    headers: MRT_Header<TData>[];
};
export type MRT_Row<TData extends MRT_RowData> = Omit<Row<TData>, 'getVisibleCells' | 'getAllCells' | 'subRows' | '_valuesCache'> & {
...
export type MRT_SortingFn<TData extends MRT_RowData> = SortingFn<TData> | MRT_SortingOption;
...
export type MRT_CreateTableFeature<TData extends MRT_RowData, TFeature = any> = (table: MRT_TableInstance<TData>) => TFeature;
/**
