...
import { type MRT_RowData, type MantineShade, type MRT_Column, type MRT_ColumnDef, type MRT_DefinedColumnDef, type MRT_DisplayColumnIds, type MRT_FilterOption, type MRT_GroupingState, type MRT_Row, type MRT_TableInstance, type MRT_TableOptions, type MRT_ColumnHelper } from './types';
...
export declare const reorderColumn: <TData extends MRT_RowData>(draggedColumn: MRT_Column<TData>, targetColumn: MRT_Column<TData>, columnOrder: import("@tanstack/react-table").ColumnOrderState) => import("@tanstack/react-table").ColumnOrderState;
