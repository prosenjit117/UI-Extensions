...
import { useMemo, useState, memo, useEffect, useRef, useCallback, useReducer, Fragment as Fragment$1, createElement, useLayoutEffect } from 'react';
...
import { useDirection, Tooltip, ActionIcon, Box, Select, TextInput, CopyButton, UnstyledButton, Highlight, TableTd, Skeleton, Collapse, TableTr, TableTbody, Text, Menu, Button, Switch, Radio, Checkbox, Flex, Progress, Group, Pagination, Badge, MultiSelect, Autocomplete, Alert, Stack, useMantineTheme, Divider, Transition, RangeSlider, Popover, Indicator, TableTh, TableThead, TableTfoot, Table, Modal, LoadingOverlay, Paper } from '@mantine/core';
...
const MRT_RowPinButton = ({ pinningPosition, row, table, }) => {
    ...
    return (jsx(Tooltip, { opened: tooltipOpened, openDelay: 1000, label: isPinned ? localization.unpin : localization.pin, children: jsx(ActionIcon, { "aria-label": localization.pin, color: "gray", onClick: handleTogglePin, onMouseEnter: () => setTooltipOpened(true), onMouseLeave: () => setTooltipOpened(false), size: "xs", variant: "subtle", style: {
                height: '24px',
                width: '24px',
...
const MRT_TableBodyCell = ({ cell, isStriped, measureElement, numRows, rowIndex, rowRef, table, virtualCell, }) => {
    ...
    return (jsxs(TableTd, Object.assign({ "data-index": virtualCell === null || virtualCell === void 0 ? void 0 : virtualCell.index, "data-pinned": column.getIsPinned() && column.columnDef.columnDefType !== 'group', ref: (node) => {
            if (node) {
...
const MRT_TableBodyRow = ({ columnVirtualizer, enableHover, isStriped, measureElement, numRows, row, rowIndex, table, pinnedRowIds, virtualRow, }) => {
    ...
    return (jsxs(Fragment, { children: [jsxs(TableTr, Object.assign({ "data-index": rowIndex, "data-selected": row.getIsSelected() || undefined, onDragEnter: handleDragEnter, ref: (node) => {
                    if (node) {
                        rowRef.current = node;
                        measureElement === null || measureElement === void 0 ? void 0 : measureElement(node);
                    }
...
const useMRT_RowVirtualizer = (table, rows) => {
    ...
    const rowVirtualizer = enableRowVirtualization
        ? useVirtualizer(Object.assign({ count: (_a = rows === null || rows === void 0 ? void 0 : rows.length) !== null && _a !== void 0 ? _a : getRowModel().rows.length, estimateSize: () => density === 'xs' ? 42.7 : density === 'md' ? 54.7 : 70.7, getScrollElement: () => tableContainerRef.current, measureElement: typeof window !== 'undefined' &&
...
const MRT_TableBody = ({ columnVirtualizer, enableHover, isStriped, table, }) => {
    ...
    return (jsxs(Fragment, { children: [!(rowPinningDisplayMode === null || rowPinningDisplayMode === void 0 ? void 0 : rowPinningDisplayMode.includes('sticky')) &&
                ...
                }) }))), rowVirtualizer && CreatingRow && (jsx(TableTbody, Object.assign({}, tableBodyProps, { style: (theme) => (Object.assign({ display: (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) ? 'grid' : undefined }, parseFromValuesOrFunc(tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.style, theme))), children: CreatingRow }))), jsxs(TableTbody, Object.assign({}, tableBodyProps, { className: clsx(classes$y.root, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$y['root-grid'], !rows.length && classes$y['root-no-rows'], rowVirtualizer && classes$y['root-virtualized'], tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.className), __vars: Object.assign({ '--mrt-table-body-height': rowVirtualizer
                        ? `${rowVirtualizer.getTotalSize()}px`
                        : undefined }, tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.__vars), children: [!rowVirtualizer && CreatingRow, (_c = tableBodyProps === null || tableBodyProps === void 0 ? void 0 : tableBodyProps.children) !== null && _c !== void 0 ? _c : (!rows.length && !CreatingRow ? (jsx("tr", { className: clsx('mrt-table-body-row', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$y['empty-row-tr-grid']), children: jsx("td", { colSpan: table.getVisibleLeafColumns().length, className: clsx('mrt-table-body-cell', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) &&
                                classes$y['empty-row-td-grid']), children: (_d = renderEmptyRowsFallback === null || renderEmptyRowsFallback === void 0 ? void 0 : renderEmptyRowsFallback({ table })) !== null && _d !== void 0 ? _d : (jsx(Text, { className: clsx(classes$y['empty-row-td-content']), __vars: {
...
const MRT_GrabHandleButton = ({ actionIconProps, onDragEnd, onDragStart, table: { options: { icons: { IconGripHorizontal }, localization: { move }, }, }, }) => {
    ...
    return (jsx(Tooltip, { withinPortal: true, openDelay: 1000, label: (_a = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _a !== void 0 ? _a : move, children: jsx(ActionIcon, Object.assign({ "aria-label": (_b = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _b !== void 0 ? _b : move, draggable: true }, actionIconProps, { onClick: (e) => {
            ...
            }, color: "gray", variant: "transparent", onDragStart: onDragStart, onDragEnd: onDragEnd, className: clsx('mrt-grab-handle-button', classes$x['grab-icon'], actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.className), title: undefined, children: jsx(IconGripHorizontal, {}) })) }));
};
...
const MRT_ExpandButton = ({ row, table, }) => {
    ...
    return (jsx(Tooltip, { withinPortal: true, disabled: !canExpand && !renderDetailPanel, openDelay: 1000, label: ((_a = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.title) !== null && _a !== void 0 ? _a : isExpanded)
            ...
            : localization.expand, children: jsx(ActionIcon, Object.assign({ "aria-label": localization.expand, color: "gray", disabled: !canExpand && !renderDetailPanel, variant: "subtle" }, actionIconProps, { onClick: handleToggleExpand, className: clsx('mrt-expand-button', classes$v.root, actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.className), title: undefined, children: (_b = actionIconProps === null || actionIconProps === void 0 ? void 0 : actionIconProps.children) !== null && _b !== void 0 ? _b : (jsx(IconChevronDown, { className: clsx('mrt-expand-button-chevron', classes$v.chevron, !canExpand && !renderDetailPanel
                    ? classes$v.right
                    : isExpanded
                        ? classes$v.up
                        : undefined) })) })) }));
...
const MRT_RowActionMenu = ({ handleEdit, row, table, }) => {
    ...
    return (jsxs(Menu, { position: positionActionsColumn === 'first'
            ...
            : positionActionsColumn === 'last'
                ? 'bottom-end'
                : undefined, closeOnItemClick: true, withinPortal: true, children: [jsx(Tooltip, { withinPortal: true, openDelay: 1000, label: localization.rowActions, children: jsx(Menu.Target, { children: jsx(ActionIcon, { "aria-label": localization.rowActions, color: "gray", onClick: (event) => event.stopPropagation(), size: "sm", variant: "subtle", children: jsx(IconDots, {}) }) }) }), jsxs(Menu.Dropdown, { onClick: (event) => event.stopPropagation(), children: [enableEditing && editDisplayMode !== 'table' && (jsx(Menu.Item, { leftSection: jsx(IconEdit, {}), onClick: handleEdit, children: localization.edit })), renderRowActionMenuItems === null || renderRowActionMenuItems === void 0 ? void 0 : renderRowActionMenuItems({
                        row,
                        table,
                    })] })] }));
};
    ...
    if (order.includes(id) &&
        ...
        return Object.assign({ Cell: ({ cell, column, row, table }) => {
                ...
                if (tableOptions.groupedColumnMode === 'remove' &&
                    ...
                    return (jsxs(Flex, { align: "center", gap: "0.25rem", children: [jsx(MRT_ExpandButton, Object.assign({}, expandButtonProps)), jsx(Tooltip, { openDelay: 1000, position: "right", label: table.getColumn(row.groupingColumnId).columnDef.header, children: jsx("span", { children: row.groupingValue }) }), !!subRowsLength && jsxs("span", { children: ["(", subRowsLength, ")"] })] }));
                }
                else {
                ...
                ? ({ table }) => {
                    return (jsxs(Flex, { align: "center", children: [jsx(MRT_ExpandAllButton, { table: table }), tableOptions.groupedColumnMode === 'remove' &&
                                grouping
...
const MRT_FilterTextInput = ({ header, rangeFilterIndex, table, }) => {
    ...
    return filterChipLabel ? (jsx(Box, { style: commonProps.style, children: jsx(Badge, { size: "lg", onClick: handleClearEmptyFilterChip, className: classes$o['filter-chip-badge'], rightSection: ClearButton, children: filterChipLabel }) })) : isMultiSelectFilter ? (jsx(MultiSelect, Object.assign({}, commonProps, { searchable: true }, multiSelectProps, { onChange: (value) => setFilterValue(value), className: clsx(className, multiSelectProps.className), data: filterSelectOptions, ref: (node) => {
            ...
            size: 'md',
        } }))) : isDateFilter ? (jsx(DateInput, Object.assign({}, commonProps, { allowDeselect: true, clearable: true, popoverProps: { withinPortal: columnFilterDisplayMode !== 'popover' } }, dateInputProps, { className: clsx(className, dateInputProps.className), ref: (node) => {
            if (node) {
                filterInputRefs.current[`${column.id}-${rangeFilterIndex !== null && rangeFilterIndex !== void 0 ? rangeFilterIndex : 0}`] =
                    node;
...
const MRT_ShowHideColumnsMenuItems = ({ allColumns, hoveredColumn, setHoveredColumn, column, table, }) => {
    ...
    return (jsxs(Fragment, { children: [jsx(Menu.Item, Object.assign({ component: "span", ref: menuItemRef, style: {
                    '--_column-depth': `${(column.depth + 0.5) * 2}rem`,
                    '--_hover-color': getPrimaryColor(theme),
                }, onDragEnter: handleDragEnter, className: classes$k.root }, dataVariable('dragging', isDragging), dataVariable('order-hovered', (hoveredColumn === null || hoveredColumn === void 0 ? void 0 : hoveredColumn.id) === column.id), { children: jsxs(Box, { className: classes$k.menu, children: [columnDefType !== 'group' &&
                            enableColumnOrdering &&
                            !allColumns.some((col) => col.columnDef.columnDefType === 'group') &&
                            (columnDef.enableColumnOrdering !== false ? (jsx(MRT_GrabHandleButton, { onDragEnd: handleDragEnd, onDragStart: handleDragStart, table: table })) : (jsx(Box, { className: classes$k.grab }))), enableColumnPinning &&
...
const MRT_ToggleFiltersButton = (_a) => {
    ...
    return (jsx(Tooltip, { withinPortal: true, label: title !== null && title !== void 0 ? title : showHideFilters, children: jsx(ActionIcon, Object.assign({ color: "gray", size: "lg", variant: "subtle", "aria-label": title !== null && title !== void 0 ? title : showHideFilters, onClick: () => setShowColumnFilters((current) => !current) }, rest, { children: showColumnFilters ? jsx(IconFilterOff, {}) : jsx(IconFilter, {}) })) }));
};
...
const MRT_ToggleFullScreenButton = (_a) => {
    ...
    return (jsx(Tooltip, { opened: tooltipOpened, withinPortal: true, label: title !== null && title !== void 0 ? title : toggleFullScreen, children: jsx(ActionIcon, Object.assign({ color: "gray", size: "lg", variant: "subtle", "aria-label": title !== null && title !== void 0 ? title : toggleFullScreen, onClick: handleToggleFullScreen, onMouseEnter: () => setTooltipOpened(true), onMouseLeave: () => setTooltipOpened(false) }, rest, { children: isFullScreen ? jsx(IconMinimize, {}) : jsx(IconMaximize, {}) })) }));
};
...
const MRT_ToolbarInternalButtons = ({ table, }) => {
    ...
    return (jsx(Flex, { className: clsx('mrt-toolbar-internal-buttons', classes$i.root), children: (_a = renderToolbarInternalActions === null || renderToolbarInternalActions === void 0 ? void 0 : renderToolbarInternalActions({ table })) !== null && _a !== void 0 ? _a : (jsxs(Fragment, { children: [enableFilters &&
                    enableGlobalFilter &&
...
const MRT_TableHeadCellFilterLabel = ({ header, table, }) => {
    ...
    const filterTooltip = columnFilterDisplayMode === 'popover' && !isFilterActive
        ...
        : localization.filteringByColumn
            ...
            : column.getFilterValue()}"`)
            .replace('" "', '');
    return (jsx(Fragment, { children: jsxs(Popover, { onClose: () => setPopoverOpened(false), opened: popoverOpened, position: "top", keepMounted: columnDef.filterVariant === 'range-slider', shadow: "xl", width: 360, withinPortal: true, children: [jsx(Transition, { transition: "scale", mounted: columnFilterDisplayMode === 'popover' ||
                        (!!column.getFilterValue() && !isRangeFilter) ||
                        (isRangeFilter &&
                            (!!((_b = column.getFilterValue()) === null || _b === void 0 ? void 0 : _b[0]) ||
                                !!((_c = column.getFilterValue()) === null || _c === void 0 ? void 0 : _c[1]))), children: () => (jsx(Popover.Target, { children: jsx(Tooltip, { disabled: popoverOpened, label: filterTooltip, multiline: true, w: filterTooltip.length > 40 ? 300 : undefined, withinPortal: true, children: jsx(ActionIcon, Object.assign({ className: clsx('mrt-table-head-cell-filter-label-icon', classes$b.root), size: 18 }, dataVariable('active', isFilterActive), { onClick: (event) => {
                                    event.stopPropagation();
...
const MRT_TableHeadCellSortLabel = ({ header, table: { getState, options: { icons: { IconSortDescending, IconSortAscending, IconArrowsSort }, localization, }, }, }) => {
    ...
    return (jsx(Tooltip, { withinPortal: true, openDelay: 1000, label: sortTooltip, children: sorting.length < 2 || sortIndex === -1 ? (jsx(ActionIcon, Object.assign({ className: clsx('mrt-table-head-sort-button', classes$9['sort-icon']), "aria-label": sortTooltip, size: 18 }, dataVariable('sorted', sorted), { children: sorted === 'desc' ? (jsx(IconSortDescending, {})) : sorted === 'asc' ? (jsx(IconSortAscending, {})) : (jsx(IconArrowsSort, {})) }))) : (jsx(Indicator, { className: clsx('mrt-table-head-multi-sort-indicator', classes$9['multi-sort-indicator']), color: "transparent", label: sortIndex + 1, offset: 4, inline: true, children: jsx(ActionIcon, Object.assign({ className: clsx('mrt-table-head-sort-button', classes$9['sort-icon']), "aria-label": sortTooltip }, dataVariable('sorted', sorted), { children: sorted === 'desc' ? (jsx(IconSortDescending, {})) : sorted === 'asc' ? (jsx(IconSortAscending, {})) : (jsx(IconArrowsSort, {})) })) })) }));
};
...
const MRT_TableHeadCell = ({ header, table, }) => {
    ...
    return (jsxs(TableTh, Object.assign({}, tableCellProps, { align: columnDefType === 'group' ? 'center' : 'left', colSpan: header.colSpan, onDragEnter: handleDragEnter, ref: (node) => {
            if (node) {
...
const MRT_TableHead = ({ table, columnVirtualizer, }) => {
    ...
    return (jsx(TableThead, Object.assign({}, tableHeadProps, { ref: (ref) => {
            ...
            (showAlertBanner || getSelectedRowModel().rows.length > 0) ? (jsx(TableTr, { className: clsx(classes$6['banner-tr'], (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$6.grid), children: jsx(TableTh, { colSpan: table.getVisibleLeafColumns().length, className: clsx(classes$6['banner-th'], (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$6.grid), children: jsx(MRT_ToolbarAlertBanner, { table: table }) }) })) : (getHeaderGroups().map((headerGroup) => (jsx(MRT_TableHeadRow, { headerGroup: headerGroup, table: table, columnVirtualizer: columnVirtualizer }, headerGroup.id)))) })));
};
...
const MRT_TableFooter = ({ table, columnVirtualizer, }) => {
    ...
    return (jsx(TableTfoot, Object.assign({}, tableFooterProps, { ref: (ref) => {
            tableFooterRef.current = ref;
            if (tableFooterProps === null || tableFooterProps === void 0 ? void 0 : tableFooterProps.ref) {
                // @ts-ignore
                tableFooterProps.ref.current = ref;
            }
        }, className: clsx(classes$3.root, tableFooterProps === null || tableFooterProps === void 0 ? void 0 : tableFooterProps.className, stickFooter && classes$3.sticky, (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$3.grid), children: getFooterGroups().map((footerGroup) => (jsx(MRT_TableFooterRow, { footerGroup: footerGroup, table: table, columnVirtualizer: columnVirtualizer }, footerGroup.id))) })));
};
...
const MRT_Table = ({ table, }) => {
    ...
    return (jsxs(Table, Object.assign({ className: clsx('mrt-table', (layoutMode === null || layoutMode === void 0 ? void 0 : layoutMode.startsWith('grid')) && classes$2['root-grid'], enableColumnResizing &&
            layoutMode === 'semantic' &&
